...
{
    public partial class KullaniciIcerikDuzenle : System.Web.UI.Page
    {
        ...
        protected void btnicerikguncelle_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Update Icerikler Set Aciklama=@Aciklama,Icerik=@Icerik,Tarih=@Tarih,Onay=@Onay Where IcerikId=" + IcerikId, baglanti);
