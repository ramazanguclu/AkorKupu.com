<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Tablar.aspx.cs" Inherits="WebApplicationAkorKupu.Tablar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="harfler" style="border: medium solid #FFFF00">
                ...
                <asp:DataList ID="dlharf" runat="server" CellPadding="4" ForeColor="#333333"
                    ...
                    <ItemTemplate>
                        <table>
                            <tr>
                                <td>
                                    <a href="Tablar.aspx?Harf=<%#Eval("Harf") %> " style="color: #0000FF; text-decoration: none;"><%#Eval("Harf") %></a></td>
                            </tr>
                        </table>
                    </ItemTemplate>
        ...
        <div class="akor_sonek">
            <div class="akor_sonek_baslik">Son Eklenen Tablar</div>
        ...
        <div class="akor_sonek">
            <div class="akor_sonek_baslik">Populer Tablar</div>
            <div class="akor_son_satir">
                <div class="akor_son_sutun_baslik">Şarkı</div>
                <div class="akor_son_sutun_iki_baslik">Versiyon</div>
                <div class="akor_son_sutun_baslik">Şarkıcı</div>
